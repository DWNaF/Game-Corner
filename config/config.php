...
if (!defined('ABS_PATH')){
    define('ABS_PATH', DIRECTORY_SEPARATOR . 'Game-Corner' . DIRECTORY_SEPARATOR);
}
...
if (!defined('UPLOADS_PATH')){
    define('UPLOADS_PATH', CSS_PATH . 'assets' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR);
}
